...
public class SpeciesView {
	...
	private void save() {
		...
		System.out.println("종 분류을 입력하세요 > ");
	...
	private void update() {
		...
		System.out.println("종 수정기능 입니당~");
		System.out.println("수정하실 종의 ID값을 입력해주세요 > ");
		String speciesId = sc.nextLine();
		System.out.println("수정하실 종의 이름을 입력하세요 > ");
		String speciesName = sc.nextLine();
		System.out.println("수정하실 종의 분류를 입력하세요 > ");
		String speciesClass = sc.nextLine();
	...
	private void findById() {
		...
		System.out.print("검색하실 아이디를 입력하세요 > ");
		String speciesId = sc.nextLine();
